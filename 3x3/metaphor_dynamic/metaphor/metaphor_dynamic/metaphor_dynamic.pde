...
void draw() {
 ...
 measlesY = random((height*0+radius)+(height*1/6), (height-radius)-(height*1/6));
  ...
  //measlesX = random(FaceDiameter*3.14 , FaceDiameter*3.14);
  //measlesY = random(FaceDiameter*3.14 , FaceDiameter*3.14);
  // measlesX1 = random(FaceDiameter*3.14 , FaceDiameter*3.14 );
    //measlesY1 = random(FaceDiameter*3.14,  FaceDiameter*3.14);
     //measlesX2 = random(FaceDiameter*3.14 ,  FaceDiameter*3.14);
      //measlesX3 = random(FaceDiameter*3.14 ,  FaceDiameter*3.14);
       //measlesY2 = random(FaceDiameter*3.14,  FaceDiameter*3.14);
  //measlesX4 =
  //measlesY3 = 
  ellipse(measlesX, measlesY, measlesdiameter, measlesdiameter);
