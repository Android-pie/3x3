...
float measlesX, measlesY, measlesdiameter, radius, measlesX1, measlesY1, measlesX2, measlesX3, measlesY2, measlesY3, measlesX4, measlesY4, measlesX5, measlesY5, measlesX6, measlesY6;
...
void draw() {
  ...
  //
  measlesX5 = random((FaceSquareX+radius)+(width*2/32), (FaceSquareX+FaceSquareSide)-(width*2/32)-radius);
  measlesY5 = random((height*0+radius)+(height*0.5/2.5), (height-radius)-(height*0.5/2.5));
  //
  measlesX6 = random((FaceSquareX+radius)+(width*0.225/20), (FaceSquareX+FaceSquareSide)-(width*0.225/20)-radius);
  measlesY6 = random((height*0+radius)+(height*0.5/1.5), (height-radius)-(height*0.5/1.5));
  ellipse(measlesX, measlesY, measlesdiameter, measlesdiameter);
  ...
  ellipse(measlesX5, measlesY5, measlesdiameter, measlesdiameter);
  ellipse(measlesX6, measlesY6, measlesdiameter, measlesdiameter);
  fill(red);
  //left eye
